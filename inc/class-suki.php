...
class Suki {
	...
	public function enqueue_frontend_styles( $hook ) {
		 ...
		 */
		wp_enqueue_style( 'tailwind', get_template_directory_uri() . '/app.css', array(), SUKI_VERSION );
	...
	public function enqueue_frontend_javascripts( $hook ) {
		...
		$ver = array();
		wp_enqueue_script( 'tailwind-js', get_template_directory_uri('app.js'), array(), SUKI_VERSION, true );
